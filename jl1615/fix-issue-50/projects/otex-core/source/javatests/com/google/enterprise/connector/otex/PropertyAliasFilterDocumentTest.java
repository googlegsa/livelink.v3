...
/**
 * Tests PropertyAliasFilterDocumentFactory.
 */
/* TODO (bmj): This should really be in the Connctor Manager. */
public class PropertyAliasFilterDocumentTest extends FilterDocumentTest {

  /** Creates a PropertyAliasFilterDocument. */
  ...
  protected static Document createFilter(Map<String, String>aliases) {
    return new PropertyAliasFilterDocumentFactory(aliases)
          .newFilterDocument(createDocument());
  }

  /** Tests the Factory constructor. */
  public void testFactory() throws Exception {
    PropertyAliasFilterDocumentFactory factory =
        new PropertyAliasFilterDocumentFactory(new HashMap<String, String>());
  ...
  public void testFactoryIllegalArgs() throws Exception {
    PropertyAliasFilterDocumentFactory factory;
    try {
      factory = new PropertyAliasFilterDocumentFactory(null);
