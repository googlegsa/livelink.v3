...
final class LapiClient implements Client {
  ...
  static {
    ...
    assert PRIV_LOGIN == LAPI_USERS.PRIV_LOGIN :
      LAPI_USERS.PRIV_LOGIN;
    assert PRIV_UAPI_SESSION == LAPI_USERS.PRIV_UAPI_SESSION :
      LAPI_USERS.PRIV_UAPI_SESSION;
    assert PRIV_DAPI_SESSION == LAPI_USERS.PRIV_DAPI_SESSION :
      LAPI_USERS.PRIV_DAPI_SESSION;
    assert PRIV_WAPI_SESSION == LAPI_USERS.PRIV_WAPI_SESSION :
      LAPI_USERS.PRIV_WAPI_SESSION;
